...
github_scenario1_measurement_params_crypto = {}
github_scenario1_measurement_params_crypto.update(user_measurement_params)
github_scenario1_measurement_params_crypto.update(content_measurement_params)
github_scenario1_measurement_params_crypto.update(community_measurement_params)
