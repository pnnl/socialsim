...
twitter_scenario1_measurement_params_crypto = {}
twitter_scenario1_measurement_params_crypto.update(user_measurement_params)
twitter_scenario1_measurement_params_crypto.update(content_measurement_params)
