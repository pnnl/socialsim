...
twitter_scenario1_measurement_params_cyber = {}
twitter_scenario1_measurement_params_cyber.update(user_measurement_params)
twitter_scenario1_measurement_params_cyber.update(content_measurement_params)
