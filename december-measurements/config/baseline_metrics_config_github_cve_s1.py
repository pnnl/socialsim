...
github_scenario1_measurement_params_cve = {}
github_scenario1_measurement_params_cve.update(user_measurement_params)
github_scenario1_measurement_params_cve.update(content_measurement_params)
github_scenario1_measurement_params_cve.update(community_measurement_params)
