...
#     },
     ...
     "most_active_users": {
         ...
         "measurement_args":{"k":10,"eventTypes":twitter_events},
         "metrics": {"rbo": named_partial(Metrics.rbo_score, p=0.58)}
     },
     ...
     "user_popularity": {
         ...
         "measurement_args":{"k":10,"eventTypes":twitter_events,"content_field":"root"},
         "metrics": {"rbo": named_partial(Metrics.rbo_score, p=0.58)}
     },
...
content_measurement_params = {
    ##Content-centric measurements
     ...
     "content_growth": {
         ...
         "measurement_args":{"eventTypes":twitter_events,"time_bin":"h","content_field":"root"},
...
#     },
     ...
     "content_popularity_topk": {
         ...
         "scenario3":True,
         "measurement": "getTopKContent",
         "measurement_args":{"k":10,"eventTypes":["retweet"],"content_field":"root"},
         "metrics": {"rbo": named_partial(Metrics.rbo_score, p=0.58)}
     },
...
twitter_scenario2_measurement_params_cve = {}
twitter_scenario2_measurement_params_cve.update(user_measurement_params)
twitter_scenario2_measurement_params_cve.update(content_measurement_params)
