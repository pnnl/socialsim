...
github_scenario1_measurement_params_cyber = {}
github_scenario1_measurement_params_cyber.update(user_measurement_params)
github_scenario1_measurement_params_cyber.update(content_measurement_params)
github_scenario1_measurement_params_cyber.update(community_measurement_params)
